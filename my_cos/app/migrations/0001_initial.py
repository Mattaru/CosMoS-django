# Generated by Django 3.1.7 on 2021-06-14 10:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=255, unique=True, verbose_name='ingredient name')),
                ('slug', models.SlugField(blank=True, max_length=255, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line', models.CharField(blank=True, max_length=125, null=True, verbose_name='line')),
                ('name', models.CharField(max_length=255, unique=True, verbose_name='product name')),
                ('slug', models.SlugField(blank=True, max_length=255, null=True, unique=True)),
                ('img', models.ImageField(default='unknown.png', upload_to=core.handlers.get_img_upload_path, verbose_name='image')),
                ...
                ('created_by', models.ForeignKey(blank=True, default=75, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='created by')),

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('line', models.CharField(blank=True, default='No line', max_length=100, verbose_name='line')),
                ...
                ('consistency_img', models.ImageField(blank=True, null=True, upload_to='product_img/consistency/', verbose_name='Consistency image')),
